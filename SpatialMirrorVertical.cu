...
__global__ void SpatialMirrorVertical_updateOutput(
...
static int extracunn_SpatialMirrorVertical_updateOutput(lua_State *L)
{
  ...
  SpatialMirrorVertical_updateOutput<<<gridSize, blockSize, 0, THCState_getCurrentStream(state)>>>(
    devInput, devOutput);

  return 1;
}

__global__ void SpatialMirrorVertical_updateGradInput(
...
static int extracunn_SpatialMirrorVertical_updateGradInput(lua_State *L)
{
  THCState *state = getCutorchState(L);
  // Inputs
  THCudaTensor *input = (THCudaTensor *)luaT_checkudata(L, 2, "torch.CudaTensor");
  ...
  SpatialMirrorVertical_updateGradInput<<<gridSize, blockSize, 0, THCState_getCurrentStream(state)>>>(
    devGradInput, devGradOutput);

  return 1;
}

static const struct luaL_Reg extracunn_SpatialMirrorVertical__ [] = {
  {"SpatialMirrorVertical_updateOutput", extracunn_SpatialMirrorVertical_updateOutput},
  {"SpatialMirrorVertical_updateGradInput", extracunn_SpatialMirrorVertical_updateGradInput},
  {NULL, NULL}
};
...
void extracunn_SpatialMirrorVertical_init(lua_State *L)
{
  ...
  luaT_registeratname(L, extracunn_SpatialMirrorVertical__, "nn");
  lua_pop(L,1);
}
